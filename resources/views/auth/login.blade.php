        ...
        <div class="rounded-md shadow-sm -space-y-px">
          <div>
            ...
            <input id="email-address" name="email" type="email" autocomplete="email" required 
                    ...
                    border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 
                    focus:border-gray-500 focus:z-10 sm:text-sm" placeholder="Email address"
                    value="{{ old('email') }}">
          ...
          <div>
            ...
            <input id="password" name="password" type="password" autocomplete="current-password" 
                    ...
                    focus:border-gray-500 focus:z-10 sm:text-sm" placeholder="Password">
